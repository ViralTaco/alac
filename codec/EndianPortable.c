...
#define BSWAP32(x)                                                  \
  (((x << 24) | ((x << 8) & 0x00ff0000) | ((x >> 8) & 0x0000ff00) | \
    ((x >> 24) & 0x000000ff)))
#define BSWAP64(x)                                                     \
  ((((int64_t)x << 56) | (((int64_t)x << 40) & 0x00ff000000000000LL) | \
    (((int64_t)x << 24) & 0x0000ff0000000000LL) |                      \
    (((int64_t)x << 8) & 0x000000ff00000000LL) |                       \
    (((int64_t)x >> 8) & 0x00000000ff000000LL) |                       \
    (((int64_t)x >> 24) & 0x0000000000ff0000LL) |                      \
    (((int64_t)x >> 40) & 0x000000000000ff00LL) |                      \
    (((int64_t)x >> 56) & 0x00000000000000ffLL)))
...
void Swap16(uint16_t* inUInt16) { *inUInt16 = BSWAP16(*inUInt16); }
...
void Swap32(uint32_t* inUInt32) { *inUInt32 = BSWAP32(*inUInt32); }
